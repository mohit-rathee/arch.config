...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "[", function () awful.spawn.with_shell("pactl -- set-sink-volume 0 +10%") end,
	      {description="Increse volume", group="Volume"}),
    awful.key({modkey,		  }, "]", function () awful.spawn.with_shell("pactl -- set-sink-volume 0 -10%") end,
	      {description="Decrease volume", group="Volume"}),
    awful.key({modkey,		  }, ";", function () awful.spawn.with_shell("brillo -q -A 5") end,
	      {description="Increase Brightness", group="Brightness"}),
    awful.key({modkey,		  }, "'", function () awful.spawn.with_shell("brillo -q -U 5") end,
	      {description="Decrease Brightness", group="Brightness"}),
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey,           }, "q", awesome.quit,
              {description = "quit awesome", group = "awesome"}),
    awful.key({ modkey,         }, ",", function () awful.spawn.with_shell("iwctl station wlan0 connect 'Bright Youth 5th floor 69g'") end,
              {description = "Connect to Bright Youth 5th floor 69g", group = "wifi"}),
    awful.key({ modkey,         }, ".", function () awful.spawn.with_shell("'iwctl station wlan0 connect 'Supreme Residency'") end,
              {description = "Connect to Supreme Residency", group = "wifi"}),
